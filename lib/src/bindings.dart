...
class EngineLib {
  ...
  EngineLib(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  EngineLib.fromLookup(
  ...
  ffi.Pointer<ffi.Char> GetTime() {
    return _GetTime();
  }

  late final _GetTimePtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>('GetTime');
  late final _GetTime =
      _GetTimePtr.asFunction<ffi.Pointer<ffi.Char> Function()>();

  void FreePointer(
    ffi.Pointer<GoInt64> pointer,
  ) {
    return _FreePointer(
      pointer,
    );
  ...
  late final _FreePointerPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<GoInt64>)>>(
          'FreePointer');
  late final _FreePointer =
      _FreePointerPtr.asFunction<void Function(ffi.Pointer<GoInt64>)>();
  ...
  late final _InitializeDartApiPtr =
      _lookup<ffi.NativeFunction<GoUint8 Function(ffi.Pointer<ffi.Void>)>>(
          'InitializeDartApi');
  ...
  late final _InitStartPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>, GoInt64)>>('InitStart');
  late final _InitStart = _InitStartPtr.asFunction<
  ...
  late final _StopWorkPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function()>>('StopWork');
  late final _StopWork = _StopWorkPtr.asFunction<void Function()>();

  void FreeCallbackMessageMemory(
    ffi.Pointer<GoInt64> pointer,
  ) {
    return _FreeCallbackMessageMemory(
      pointer,
    );
  }

  late final _FreeCallbackMessageMemoryPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<GoInt64>)>>(
          'FreeCallbackMessageMemory');
  late final _FreeCallbackMessageMemory = _FreeCallbackMessageMemoryPtr
      .asFunction<void Function(ffi.Pointer<GoInt64>)>();
